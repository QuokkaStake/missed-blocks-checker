...
func TestReporterSubscribeInvalidInvocation(t *testing.T) {
	httpmock.Activate()
	...
	httpmock.RegisterMatcherResponder(
		...
		types.TelegramResponseHasText("Usage: /subscribe &lt;validator address&gt;"),
	...
	err := reporter.HandleSubscribe(ctx)
	require.NoError(t, err)
}

//nolint:paralleltest // disabled
func TestReporterSubscribeValidatorNotFound(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Could not find a validator with address <code>validator1</code> on chain!"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")),
	)
...
//nolint:paralleltest // disabled
func TestReporterSubscribeValidatorAlreadySubscribed(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("You are already subscribed to this validator's notifications!"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")),
	)
...
//nolint:paralleltest // disabled
func TestReporterSubscribeValidatorOk(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
	...
	httpmock.RegisterMatcherResponder(
		"POST",
		"https://api.telegram.org/botxxx:yyy/sendMessage",
		types.TelegramResponseHasText("Subscribed to validator's notifications on chain: moniker1"),
		httpmock.NewBytesResponder(200, assets.GetBytesOrPanic("telegram-send-message-ok.json")),
	)
